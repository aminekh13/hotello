                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @elseif(Auth::user()->isAgent())
                            ...
                            <x-nav-link :href="route('agent.bookings.create')" :active="request()->routeIs('agent.bookings.create')">
                                {{ __('Create Booking') }}
                            </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <div class="text-xs">{{ ucfirst(Auth::user()->role) }}</div>
                        </div>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @elseif(Auth::user()->isAgent())
                    ...
                    <x-responsive-nav-link :href="route('agent.bookings.create')" :active="request()->routeIs('agent.bookings.create')">
                        {{ __('Create Booking') }}
                    </x-responsive-nav-link>
                @elseif(Auth::user()->isCustomer())
                    <!-- Customer Links -->
